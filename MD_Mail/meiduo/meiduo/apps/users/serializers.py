...
from meiduo.meiduo.apps.users import constants
from meiduo.meiduo.apps.users.models import User, Address
from meiduo.celery_tasks.email.tasks import send_verify_email
from meiduo.meiduo.utils import tjws
...
class AddUserBrowsingHistorySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        # 只保存最多5条记录
        pl.ltrim('history_%s' % user_id, 0, constants.USER_BROWSING_HISTORY_COUNTS_LIMIT)
