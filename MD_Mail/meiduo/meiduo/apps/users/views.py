...
from meiduo.meiduo.apps.carts.utils import merge_cart_cookie_to_redis
from meiduo.meiduo.apps.contents.crons import generate_static_index_html
from meiduo.meiduo.apps.goods.models import SKU
from meiduo.meiduo.apps.goods.serializers import SKUSerializer
from meiduo.meiduo.apps.users import serializers, constants
from meiduo.meiduo.apps.users.models import User

# url(r'^usernames/(?P<username>\w{5,20})/count/$', views.UsernameCountView.as_view())
from meiduo.meiduo.apps.users.serializers import CreateUserSerializer, UserDetailSerializer, EmailSerializer, EmailVerifySerializer, \
